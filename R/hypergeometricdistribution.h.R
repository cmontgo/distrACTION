...
HypergeometricDistributionOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "HypergeometricDistributionOptions",
    ...
    active = list(
        ...
        dp3 = function() private$..dp3$value),
    private = list(
...
HypergeometricDistributionResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "HypergeometricDistributionResults",
...
HypergeometricDistributionBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "HypergeometricDistributionBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = HypergeometricDistributionResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
HypergeometricDistribution <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("HypergeometricDistribution requires jmvcore to be installed (restart may be required)")


    options <- HypergeometricDistributionOptions$new(
    ...
    analysis <- HypergeometricDistributionClass$new(
        options = options,
        data = data)
