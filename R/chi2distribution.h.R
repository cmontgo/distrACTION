...
Chi2DistributionOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Chi2DistributionOptions",
...
Chi2DistributionResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Chi2DistributionResults",
...
Chi2DistributionBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = Chi2DistributionResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
Chi2Distribution <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("Chi2Distribution requires jmvcore to be installed (restart may be required)")


    options <- Chi2DistributionOptions$new(
    ...
    analysis <- Chi2DistributionClass$new(
        options = options,
        data = data)
