...
FDistributionOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "FDistributionOptions",
...
FDistributionResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "FDistributionResults",
...
FDistributionBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "FDistributionBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = FDistributionResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
FDistribution <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("FDistribution requires jmvcore to be installed (restart may be required)")


    options <- FDistributionOptions$new(
    ...
    analysis <- FDistributionClass$new(
        options = options,
        data = data)
