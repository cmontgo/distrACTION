...
NegativeBinomialDistributionOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "NegativeBinomialDistributionOptions",
...
NegativeBinomialDistributionResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "NegativeBinomialDistributionResults",
...
NegativeBinomialDistributionBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "NegativeBinomialDistributionBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = NegativeBinomialDistributionResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
#'
#' @export
NegativeBinomialDistribution <- function(
    DistributionFunction = FALSE,
    QuantileFunction = FALSE,
    QuantileFunctionType = "central",
    DistributionFunctionType = "is",
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("NegativeBinomialDistribution requires jmvcore to be installed (restart may be required)")


    options <- NegativeBinomialDistributionOptions$new(
    ...
    analysis <- NegativeBinomialDistributionClass$new(
        options = options,
        data = data)
